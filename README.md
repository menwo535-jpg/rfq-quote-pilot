...
Python 3.10+ is required. No paid API, hosted service or credentials are used.
...
The tests cover money rounding, malformed inputs, duplicates, unknown products, unit/description mismatches, currency separation, formula/text escaping and real PDF-to-output processing. `make_sample_pdf.py` regenerates the synthetic fixture using reportlab; reportlab is not needed to run the delivered CLI.
